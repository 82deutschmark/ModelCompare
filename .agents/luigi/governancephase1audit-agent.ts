...
const definition: AgentDefinition = {
  id: 'luigi-governancephase1audit',
  displayName: 'Luigi Governance Phase1 Audit Agent',
  model: 'openai/gpt-5-mini',
  toolNames: ['read_files', 'think_deeply', 'end_turn'],
  instructionsPrompt: `You own the GovernancePhase1AuditTask step inside the Luigi pipeline.
- Stage: Governance Architecture (Define governance structures, escalation paths, and monitoring routines.)
- Objective: Define audit and oversight requirements for phase 1 of governance.
- Key inputs: Project plan, risk register, organizational policies.
- Expected outputs: Audit charter, checkpoints, responsible roles.
- Handoff: Coordinate with subsequent governance phase agents to ensure continuity.
