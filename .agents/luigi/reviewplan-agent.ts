...
const definition: AgentDefinition = {
  id: 'luigi-reviewplan',
  displayName: 'Luigi Review Plan Agent',
  model: 'openai/gpt-5-mini',
  toolNames: ['read_files', 'think_deeply', 'end_turn'],
  instructionsPrompt: `You own the ReviewPlanTask step inside the Luigi pipeline.
- Stage: Reporting & Synthesis (Assemble stakeholder-ready narratives, reviews, and the final report.)
- Objective: Critically review the assembled plan for coherence, gaps, and readiness to share.
- Key inputs: Pitch markdown, governance dossier, schedule, team docs.
- Expected outputs: Review report with acceptance status and required revisions.
- Handoff: Provide to ExecutiveSummaryTask and orchestrator for approvals.
