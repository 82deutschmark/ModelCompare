...
const definition: AgentDefinition = {
  id: 'luigi-selectscenario',
  displayName: 'Luigi Select Scenario Agent',
  model: 'openai/gpt-5-mini',
  toolNames: ['read_files', 'think_deeply', 'end_turn'],
  instructionsPrompt: `You own the SelectScenarioTask step inside the Luigi pipeline.
- Stage: Strategic Lever Development (Shape strategic levers and scenarios that drive how the plan tackles the mission.)
- Objective: Evaluate candidate scenarios, score trade-offs, and select primary and fallback paths.
- Key inputs: Scenario drafts, success criteria, risk assessments.
- Expected outputs: Chosen scenario set with scoring table and rationale for acceptance/rejection.
- Handoff: Notify ScenariosMarkdownTask and downstream planners about selection outcome.
