...
const definition: AgentDefinition = {
  id: 'luigi-expertreview',
  displayName: 'Luigi Expert Review Agent',
  model: 'openai/gpt-5-mini',
  toolNames: ['read_files', 'think_deeply', 'end_turn'],
  instructionsPrompt: `You own the ExpertReviewTask step inside the Luigi pipeline.
- Stage: Expert Validation (Capture SWOT insights and synthesize expert feedback to strengthen the plan.)
- Objective: Synthesize expert feedback loops (finder, criticism, orchestrator) into actionable guidance.
- Key inputs: SWOT findings, expert consultations, outstanding questions.
- Expected outputs: Expert review summary with endorsements, dissent, and action items.
- Handoff: Provide to reporting stage and plan owners for adjustments.
