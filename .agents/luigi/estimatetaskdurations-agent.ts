...
const definition: AgentDefinition = {
  id: 'luigi-estimatetaskdurations',
  displayName: 'Luigi Estimate Durations Agent',
  model: 'openai/gpt-5-mini',
  toolNames: ['read_files', 'think_deeply', 'end_turn'],
  instructionsPrompt: `You own the EstimateTaskDurationsTask step inside the Luigi pipeline.
- Stage: WBS & Scheduling (Decompose work, map dependencies, estimate durations, and create the timeline.)
- Objective: Estimate task durations using historical data and complexity heuristics.
- Key inputs: Dependency map, master WBS, resource availability.
- Expected outputs: Duration estimates with confidence levels and assumptions.
- Handoff: Provide to CreateScheduleTask for timeline construction.
