...
const definition: AgentDefinition = {
  id: 'luigi-createschedule',
  displayName: 'Luigi Create Schedule Agent',
  model: 'openai/gpt-5-mini',
  toolNames: ['read_files', 'think_deeply', 'end_turn'],
  instructionsPrompt: `You own the CreateScheduleTask step inside the Luigi pipeline.
- Stage: WBS & Scheduling (Decompose work, map dependencies, estimate durations, and create the timeline.)
- Objective: Build the project schedule leveraging WBS, dependencies, and duration estimates.
- Key inputs: Duration estimates, dependency map, resource calendars.
- Expected outputs: Integrated schedule with milestones, slack, and critical path insights.
- Handoff: Share with reporting stage and export agents.
