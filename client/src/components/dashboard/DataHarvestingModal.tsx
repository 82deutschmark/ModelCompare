...
export const DataHarvestingModal: React.FC = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="relative overflow-hidden border border-fuchsia-500/40 bg-slate-950/95 text-rose-100 shadow-[0_0_45px_rgba(255,0,128,0.35)]">
        <motion.div
        ...
        <DialogFooter className="relative z-10 flex-col gap-3 sm:flex-row sm:justify-between">
          <Button
            variant="secondary"
