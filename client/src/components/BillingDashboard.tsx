 ...
 * Date: 2025-01-27
 * PURPOSE: BillingDashboard component provides a unified billing management interface.
 * Combines CreditBalance, PricingTable, and PaymentHistory into organized tabs.
 * Includes account settings section and handles payment flows between components.
 * SRP check: Pass - Single responsibility (billing dashboard orchestration)
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground ml-6">John Doe</p>
            </div>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
              ...
              <p className="text-sm text-muted-foreground ml-6">john.doe@example.com</p>
            </div>
          </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="flex items-center space-x-1">
                  <span className="text-2xl font-bold text-green-600 dark:text-green-400">127</span>
          ...
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <div className="flex items-center space-x-1">
                  <span className="text-2xl font-bold">$189.97</span>
                </div>
              </div>
            </div>
          </CardContent>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Credit Purchase - 500 credits</p>
                      <p className="text-xs text-muted-foreground">January 15, 2025</p>
                    </div>
                  </div>
                  <span className="text-sm font-medium text-green-600 dark:text-green-400">$19.99</span>
                </div>
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                    <div>
                      <p className="text-sm font-medium">API Usage - December</p>
